...
<body>
    <form id="form1" runat="server">
            ...
            <asp:Button ID="btnManagerLogin" runat="server" BackColor="Black" BorderColor="Black" BorderStyle="None" Height="36px" style="z-index: 1; left: 721px; top: 75px; position: absolute; width: 250px" Text="Manager Login" Width="129px" OnClick="btnBlank_Click" Font-Bold="True" ForeColor="White" />
