...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblRegisterSuccessful" runat="server" style="z-index: 1; left: 18px; top: 162px; position: absolute" Text="You have registered successfully. Start search for your future car. "></asp:Label>
        <asp:Label ID="lblRegister" runat="server" Font-Bold="False" Font-Size="XX-Large" style="z-index: 1; left: 14px; top: 124px; position: absolute" Text="Register"></asp:Label>
        ...
        <asp:TextBox ID="txtbxEmail" runat="server" style="z-index: 1; left: 177px; top: 290px; position: absolute"></asp:TextBox>
