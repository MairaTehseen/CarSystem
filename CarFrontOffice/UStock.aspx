<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UStock.aspx.cs" Inherits="AStock" %>
...
<body style="background-color: #CCCCCC">
    <form id="form1" runat="server">
        <img src="carlogo.jpg" style="height: 101px; width : 332px; float:right" /><div>
            <h1 class="auto-style1">&nbsp;Update stock</h1>
        </div>
        ...
        <asp:Button ID="btnUpdate" runat="server" style="z-index: 20; left: 27px; top: 236px; position: absolute; height: 26px; width: 59px; right: 1205px;" Text="Update" OnClick="btnOK_Click" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 105px; top: 236px; position: absolute" Text="Cancel" OnClick="btnCancel_Click" />
