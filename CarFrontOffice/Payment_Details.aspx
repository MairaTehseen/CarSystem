...
<body>
    <form id="form1" runat="server">   
        ...
        <div style="width:50%;text-align:center"><asp:Label ID="Label3" runat="server" Text="Cards"></asp:Label>
        ...
        <div style="width:50%;float:left"><asp:ListBox ID="ListBox1" runat="server" Width="100%"></asp:ListBox></div>
            ...
            <div style="padding-left:5%;padding-top:10px;float:left"> <asp:Button ID="Button4" runat="server" Text="Add new"  /></div>
